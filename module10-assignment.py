...
satisfaction_median = float(df_no_missing["satisfaction_rating"].median())
...
df_no_duplicates["purchase_frequency_category"] = df_no_duplicates["total_purchases"].apply(purchase_level)
...
# Your code here
df_final = df_renamed.drop(columns=["Phone"])
...
# Your code here
satisfaction_spend_corr = float(df_final["Satisfaction Rating"].corr(df_final["Total Spent"]))
...
print("- Data Type Issues: dates were text, total_spent had symbols, and some numeric values needed conversion")
...
print("- Categories: Standardized capitalization for product categories")
...
print(f"- Top Category: {top_category} with ${top_category_revenue:.2f}")
